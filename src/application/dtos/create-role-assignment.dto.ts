...
export class CreateRoleAssignmentDto {
  ...
  @ApiProperty({
    example: ["ENVPERM0"],
    type: [String],
    description: "Environment permission IDs",
  })
  @IsArray()
  @IsString({ each: true })
  ...
  @ApiProperty({
    ...
    example: RoleAssignmentState.ACTIVE,
    required: false,
  })
  @IsOptional()
  ...
  @ApiProperty({
    example: "USER4",
    description: "User ID of who granted this assignment",
  })
  @IsNotEmpty()
  @IsString()
  grantedBy: string;
