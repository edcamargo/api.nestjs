...
export interface IRoleAssignmentRepository {
  ...
  findById(id: string, includeDeleted?: boolean): Promise<RoleAssignment | null>;
  findByUserId(userId: string, includeDeleted?: boolean): Promise<RoleAssignment[]>;
  findActiveByUserId(userId: string): Promise<RoleAssignment[]>;
  findByGrantedBy(grantedBy: string, includeDeleted?: boolean): Promise<RoleAssignment[]>;
  update(id: string, assignment: Partial<RoleAssignment>): Promise<RoleAssignment>;
