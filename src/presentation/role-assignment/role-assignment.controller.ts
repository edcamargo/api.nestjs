...
export class RoleAssignmentController {
  ...
  @ApiResponse({ status: 201, description: 'Role assignment created successfully', type: RoleAssignmentResponseDto })
  @ApiResponse({ status: 404, description: 'User not found' })
  @ApiResponse({ status: 400, description: 'Invalid date range' })
  async create(@Body() createDto: CreateRoleAssignmentDto): Promise<{ data: RoleAssignmentResponseDto }> {
  ...
  @ApiResponse({ status: 200, description: 'Role assignments retrieved successfully', type: [RoleAssignmentResponseDto] })
  async findAll(@Query('includeDeleted') includeDeleted?: string): Promise<{ data: RoleAssignmentResponseDto[] }> {
    const assignments = await this.roleAssignmentService.findAll(includeDeleted === 'true');
  ...
  @ApiResponse({ status: 200, description: 'Role assignments retrieved successfully', type: [RoleAssignmentResponseDto] })
  async findByUserId(@Param('userId') userId: string): Promise<{ data: RoleAssignmentResponseDto[] }> {
  ...
  @ApiResponse({ status: 200, description: 'Active role assignments retrieved successfully', type: [RoleAssignmentResponseDto] })
  async findActiveByUserId(@Param('userId') userId: string): Promise<{ data: RoleAssignmentResponseDto[] }> {
    const assignments = await this.roleAssignmentService.findActiveByUserId(userId);
    return { data: RoleAssignmentMapper.toResponseArray(assignments) };
  }
  ...
  @ApiResponse({ status: 200, description: 'Role assignment retrieved successfully', type: RoleAssignmentResponseDto })
  @ApiResponse({ status: 404, description: 'Role assignment not found' })
  async findById(@Param('id') id: string): Promise<{ data: RoleAssignmentResponseDto }> {
  ...
  @ApiResponse({ status: 200, description: 'Role assignment updated successfully', type: RoleAssignmentResponseDto })
  @ApiResponse({ status: 404, description: 'Role assignment not found' })
  @ApiResponse({ status: 400, description: 'Invalid date range' })
  async update(@Param('id') id: string, @Body() updateDto: UpdateRoleAssignmentDto): Promise<{ data: RoleAssignmentResponseDto }> {
  ...
  @ApiResponse({ status: 204, description: 'Role assignment deleted successfully' })
  @ApiResponse({ status: 404, description: 'Role assignment not found' })
  ...
  @ApiResponse({ status: 404, description: 'Role assignment not found' })
  async restore(@Param('id') id: string): Promise<{ data: RoleAssignmentResponseDto }> {
  ...
  @ApiResponse({ status: 204, description: 'Role assignment permanently deleted' })
  @ApiResponse({ status: 404, description: 'Role assignment not found' })
